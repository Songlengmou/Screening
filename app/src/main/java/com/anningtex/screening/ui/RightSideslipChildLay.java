...
import com.anningtex.screening.adapter.ScreeningListAdapter;
...
public class RightSideslipChildLay extends FrameLayout {
    ...
    private void initView(List<AttrList.Attr.Vals> datas, List<AttrList.Attr.Vals> Fristlist) {
        ...
        mBrandList = findViewById(R.id.select_brand_list);
        meunBackIm = findViewById(R.id.select_brand_back_im);
        meunOkTv = findViewById(R.id.select_brand_ok_tv);
